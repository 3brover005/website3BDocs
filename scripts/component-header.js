class ComponentHeader extends HTMLElement {
    ...
    connectedCallback() {
        this.renderElement();
        console.log('Header Loaded', this.tabs);        
    }
        ...
        this.innerHTML = `
            <header class="">
                ...
                <div class="slds-p-top_x-small">
                    ...
                    <!-- App Navigation Bar -->
                    <div class="slds-context-bar slds-scrollable_x">
                    ...
                    <nav class="slds-context-bar__secondary" role="navigation">
                        <ul class="slds-grid">
                            <li class="slds-context-bar__item ${this.activeTab == 'App' ? 'slds-is-active' : ''}">
                                <a href="./" class="slds-context-bar__label-action" title="App">
                            ...
                            <li class="slds-context-bar__item ${this.activeTab == 'Contact Us' ? 'slds-is-active' : ''}">
                                <a href="./contactus" class="slds-context-bar__label-action" title="Contact Us">
